 ...
 * `IFleetMonitorService`. I primi due ci sono — il secondo da M5: un veicolo che entra in officina
 * sparisce dalla mappa dell'operatore, e la dashboard deve saperlo senza ricaricare (R7, NFR2).
